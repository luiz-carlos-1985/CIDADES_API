...
import com.github.luizcarlos1985.cidadesapi.cidades.distancias.service.EarthRadius;
...
public class DistanciaRecurso {
    ...
    @GetMapping("/cube")
    public ResponseEntity Cube(@RequestParam(name = "from") final Long city1,
                         @RequestParam(name = "to") final Long city2) {
        log.info("byCube");
    ...
    @GetMapping("/math")
    public Double Math(@RequestParam(name = "from") final Long city1,
                         @RequestParam(name = "to") final Long city2,
